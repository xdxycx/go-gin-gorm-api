...
This extended guide includes the basic Docker Compose deployment steps plus usage for the helper scripts in `scripts/`.
...
Notes
- `DEPLOY.md` remains as a short deployment guide. `DEPLOY_EXTENDED.md` contains the extended scripts usage. You can keep either one or rename/move as needed.
